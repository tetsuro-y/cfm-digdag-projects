...
DELETE FROM TAT_DB_HISTORY_MAILMAG_USER
WHERE
    (HMU_DATE >= CURRENT_DATE AND HMU_DATE < CURRENT_DATE + INTERVAL '1DAY')
    OR HMU_DATE < DATE_TRUNC('MONTH', CURRENT_DATE + INTERVAL '-25MONTHS')::DATE;
