...
SELECT 
    ...
    ,ROUND(100.0 * RAP_CNT_CV_IOS / RAP_CNT_CLICK_IOS, 2) AS RAP_RATE_CV_PER_CLICK_IOS
    ,ROUND(100.0 * RAP_CNT_CV_ANDROID / RAP_CNT_CLICK_ANDROID, 2) AS RAP_RATE_CV_PER_CLICK_ANDROID
