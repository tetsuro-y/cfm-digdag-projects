...
FROM
    TRTM_OFFER_DELIVERY
WHERE
    OFFER_DELIVERY_DT >= '2018-08-06'::TIMESTAMP + INTERVAL '-8DAYS'
    AND OFFER_DELIVERY_DT < '2018-08-06'::TIMESTAMP
...
WHERE
    DELIVERYDT >= '2018-08-06'::TIMESTAMP + INTERVAL '-8DAYS'
    AND DELIVERYDT < '2018-08-06'::TIMESTAMP
...
WHERE
    ...
    AND ORORDERDT >= '2018-08-06'::TIMESTAMP + INTERVAL '-8DAYS'
GROUP BY
    TO_ORDERDT
    ,TO_MEMBERID
    ,TO_GOODSID
    ...
    FROM (
        ...
        FROM (
            ...
            FROM
                TFAVORITELIST
            WHERE
                FLREGISTDT >= '2018-08-06'::TIMESTAMP + INTERVAL '-8DAYS'
            ...
            WHERE
                FLDREGISTDT >= '2018-08-06'::TIMESTAMP + INTERVAL '-8DAYS'
...
FROM (
    ...
    LEFT OUTER JOIN (
        ...
        WHERE
            HVU_SENDDT >= '2018-08-06'::DATE + INTERVAL '-8DAYS'
...
WHERE RPA_SENDDT >= '2018-08-06'::DATE + INTERVAL '-8DAYS' OR RPA_SENDDT < DATE_TRUNC('MONTH','2018-08-06'::DATE + INTERVAL '-25MONTHS')
;
