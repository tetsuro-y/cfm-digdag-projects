...
SELECT
    ...
    ,FULLVISITORID
FROM
	EXTERNAL 'C:\Users\keiko\Documents\BQtoPD\TAT_DB_HISTORY_PUSH_USER_TEMP.csv'--digdagの環境にあわせ変更予定
...
--DELETE FROM TAT_DB_HISTORY_PUSH_USER WHERE HPU_DATE >= CURRENT_DATE AND HPU_DATE < CURRENT_DATE + INTERVAL '1DAY';
