...
SELECT
    '20151201' AS TT_STARTDT
    ,'20161201' AS TT_ENDDT
;
...
SELECT
    NULL AS TD_OFFERID
    ,MPM_MAPPINGID AS TD_CAMPAIGNID
    ,PNDLMEMBERID AS TD_MEMBERID
    ,NULL AS TD_EMAILID
    ,2 AS TD_CHANNELID--LINE
    ,2 AS TD_DEVICEID--SP
    ,PNDLCONTACTDT AS TD_SENDDT
    ,NULL AS TD_OPENDT
    ,NULL AS TD_CLICKDT
FROM
    TPNNOTICEDELIVERY4LINE
    INNER JOIN TAT_DB_MASTER_PARAMETER_MAPPING ON PNDLCAMPAIGNID::VARCHAR(30) = MPM_PARAMETER
WHERE
...
SELECT
    ...
    ,ROUND(ODPRICE * CAVALUE, 0) * ODQUANTITY AS TO_BUYPRICE
FROM
    TORDER
